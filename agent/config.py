...
TMS_FETCH_TIMEOUT_S = 180                   # hard cap on the TMS POD/DO-sender fetch block (login wait + navigation + download)
RESEND_NOTICE = False                       # prepend transmission error notice to outgoing emails (turn off when done)
